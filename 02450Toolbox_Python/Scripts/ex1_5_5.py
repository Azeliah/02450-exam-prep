...
import numpy as np
# In this exercise we will rely on pandas for some processing steps:
import pandas as pd
...
# First of we simply read the file in using read_csv, however, we need to
...
# to have included a shortened form the variables (check messy_data.head()):
...
# At this point, you'll see that some missing values from the data
...
# that have this value of MPG are therefore incorrect, and we should treat
